...
<img src="/assets/Related_Loss_Curves/RL_Loss_Curve_Example.png" alt="drawing" width="400"/>
...
For starters, I'll unless otherwise stated, I'll be performing various benchmarks on a PPO model (the code for which can be [found here](https://github.com/tristongrayston/ExploratoryDesigninRL)) with 3 dense layers, 64 neurons wide each for both actor and critic models. (The actor and critic models have no overlapping layers as of now, that will probably be one of the tests).
